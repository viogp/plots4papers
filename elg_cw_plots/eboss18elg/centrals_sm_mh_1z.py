...
for iz,zsnap in enumerate(snap_list):
                ...
                if (first):
                    ...
                    for index,ib in enumerate(bands):
                        if (index==0):
                            ...
                            arr = f['Output001/mag_'+ib+'_o_tot_ext'].value + tomag
                    ...
                    for index,ib in enumerate(bands):
                        if (index==0):
                            inmag = f['Output001/mag_'+ib+'_o_tot_ext'].value + tomag
    ...
    print 'All centrals ',model  ; ind = np.where((lhist>11.70) & (lhist<12.4))
    print lhist[ind] ; print py[ind] ; print nall_p9[ind]-nall_p1[ind]
    ...
    for index,ib in enumerate(bands):        
        ...
        print inleg[index] ; ind = np.where((lhist>11.70) & (lhist<12.4))
        print lhist[ind] ; print py[ind] ; print nelgs_p9[index,ind]-nelgs_p1[index,ind]
    ...
    print 'eBOSS' ; ind = np.where((lhist>11.70) & (lhist<12.4))
    print lhist[ind] ; print py[ind] ; print neboss_p9[ind]-neboss_p1[ind]
    ...
    print 'DESI' ; ind = np.where((lhist>11.70) & (lhist<12.4))
    print lhist[ind] ; print py[ind] ; print ndesi_p9[ind]-ndesi_p1[ind]
