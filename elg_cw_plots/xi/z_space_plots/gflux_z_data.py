...
plotfile = plotdir+model+ 'zspace_z'+iz+'_gfluxfavole.pdf'
...
surveys=['fm16gflux_CUTExi_z.dat','fm18gflux_CUTExi_z.dat','g22.2gflux_CUTExi_z.dat','g22.8gflux_CUTExi_z.dat']
inleg = ['$F_{[OII]}>10^{-16}erg\,s^{-1}cm^{-2}$','$F_{[OII]}>10^{-18}erg\,s^{-1}cm^{-2}$','20<g<22.2','20<g<22.8']


#surveys=['fm16gflux_CUTExi_z.dat','fm18gflux_CUTExi_z.dat','g22.2favole_CUTExi_z.dat','g22.2gflux_CUTExi_z.dat','g22.8favole_CUTExi_z.dat','g22.8gflux_CUTExi_z.dat']
#inleg = ['$F_{[OII]}>10^{-16}erg\,s^{-1}cm^{-2}$','$F_{[OII]}>10^{-18}erg\,s^{-1}cm^{-2}$','20<g<22.2 +Favole colours','20<g<22.2','20<g<22.8 +Favole colours','20<g<22.8']
