...
surveys = ['DEEP2','VVDSDEEP','eBOSS-SGC','DESI']
model = 'gp19' 
inleg = surveys
...
npairs = 1.
plotdir = '/cosma5/data/durham/violeta/lines/cosmicweb/plots/'+model+'/xi/'
plotfile = plotdir+'all_xi_bias_z'+iz+'.pdf'
