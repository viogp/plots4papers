...
# Survey 'DEEP2','VVDSDEEP','VVDSWIDE','eBOSS-SGC','DESI'
survey = 'eBOSS-SGC'
...
npairs = 1.
plotdir = '/gpfs/data/violeta/lines/cosmicweb/plots/xi/'
plotfile = plotdir+survey+'_xi_bias_z'+iz+'.pdf'

pathgal = '/gpfs/data/violeta/Galform_Out/v2.7.0/stable/MillGas/'
#############################
